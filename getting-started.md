...
```sh
git clone https://github.com/jhoughjr/docs ~/repos/docs
```
...
`~/repos/docs/bin/new-app.sh` and `bin/publish-route.sh` — `DOKKU` (your
host) and `DOMAIN` (your zone).

## 5. First app — one command

```sh
~/repos/docs/bin/new-app.sh hello --static
```
...
- **The [playbook](#pi-platform-playbook.md)** — persistent storage,
